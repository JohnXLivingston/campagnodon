...
function campagnodon_declarer_tables_objets_sql($tables) {
  $tables['spip_campagnodon_transactions'] = [
    ...
    'field' => [
      ...
      'type_transaction' => "varchar(30) NOT NULL DEFAULT 'don'", // 'don', 'adhesion', 'don_mensuel', 'adhesion_annuel', 'adhesion_mensuel_echeance', ...
      'statut_recurrence' => "varchar(20) DEFAULT NULL", // Si c'est un don_mensuel/adhesion_annuel, on a ici le statut de l'abonnement. Valeurs: 'attente', 'encours', 'termine'.
