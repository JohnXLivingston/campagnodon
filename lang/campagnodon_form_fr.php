...
$GLOBALS[$GLOBALS['idx_lang']] = array(
  ...
  'option_revenu_entre' => '@montant@ € (entre @min@ € et @max@ € de revenus mensuels)',
  'option_revenu_en_dessous' => '@montant@ € (moins de @max@ € de revenus mensuels)',
  'option_revenu_au_dessus' => '@montant@ € (plus de @min@ € de revenus mensuels)',
